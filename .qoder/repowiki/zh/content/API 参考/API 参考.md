...
graph TB
subgraph "包与文档"
Pkg["@excalidraw/excalidraw<br/>package.json 导出"]
Docs["官方文档<br/>dev-docs/docs/@excalidraw/excalidraw/api/*"]
end
subgraph "示例与应用"
NextJS["Next.js 示例<br/>examples/with-nextjs/*"]
Browser["浏览器脚本示例<br/>examples/with-script-in-browser/*"]
App["应用层封装<br/>excalidraw-app/*"]
end
Pkg --> Docs
NextJS --> Pkg
Browser --> Pkg
...
```mermaid
graph TB
App["应用层<br/>excalidraw-app/App.tsx"]
Comp["@excalidraw/excalidraw 组件"]
Docs["官方文档<br/>dev-docs/docs/@excalidraw/excalidraw/*"]
Utils["工具函数<br/>导出/恢复等"]
Children["子组件<br/>侧边栏/菜单/页脚等"]
App --> Comp
Comp --> Children
Comp --> Utils
App --> Docs
